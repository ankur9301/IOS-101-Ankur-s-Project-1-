...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    ...
    // ...
      ...
      case .incorrect:
          contentView.backgroundColor=UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1)
          layer.borderColor=UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1).cgColor
          
          
      case .correctLetterOnly:
          contentView.backgroundColor=UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1)
...
//      if (LetterCellStyle!=.initial){
//          cell.backrgoundColor = UIColor(red: 0.23, green: .23, blue: .24, alpha: 1)
